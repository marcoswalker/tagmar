export default class tagmarItemSheet extends ItemSheet {
    ...
    get template() {
        ...
        if (layout != "base") {
            return 'systems/tagmar/templates/sheets/'+ this.object.type.toLowerCase() +'-ficha.hbs';
        } else {
            return 'systems/tagmar/templates/sheets/'+ this.object.type.toLowerCase() +'-sheet.hbs';
        }
    }
